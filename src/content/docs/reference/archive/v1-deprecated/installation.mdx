...
<Aside type="caution">
This v1 page is deprecated. Use <a href={`${import.meta.env.BASE_URL}collector/v2/installation/`}>Standalone Installation</a> for new deployments, or <a href={`${import.meta.env.BASE_URL}collector/v2/migration/`}>Migrate from v1</a>.
</Aside>
