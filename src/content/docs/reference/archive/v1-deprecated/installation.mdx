...
<Aside type="caution">
This v1 page is deprecated. Use <a href={`${import.meta.env.BASE_URL}collector/v2/installation/`}>v2 Installation</a> for new deployments, or <a href={`${import.meta.env.BASE_URL}collector/v2/migration/`}>Migrate from v1</a>.
</Aside>
...
<Aside type="note">
Enable at least one output (`dynatrace`, `splunk`, or `console`), otherwise the collector fails to start.
</Aside>

Full settings reference: [Configuration Reference](/reference/archive/v1-deprecated/configuration/)
