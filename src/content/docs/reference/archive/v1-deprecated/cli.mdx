...
<Aside type="caution">
This v1 page is deprecated. Use <a href={`${import.meta.env.BASE_URL}collector/standalone/cli/`}>Standalone CLI</a> for new deployments, or <a href={`${import.meta.env.BASE_URL}collector/standalone/migration/`}>Migrate from v1</a>.
</Aside>
...
For complete operational procedures, see [Service Management (v1)](../service/).
