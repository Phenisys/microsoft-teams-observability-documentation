---
title: CLI Reference
description: Command-line options for the v1 collector binary.
sidebar:
  label: CLI
  order: 3
---
...
<Aside type="caution">
This v1 page is deprecated. Use <a href={`${import.meta.env.BASE_URL}collector/v2/cli/`}>v2 CLI</a> for new deployments, or <a href={`${import.meta.env.BASE_URL}collector/v2/migration/`}>Migrate from v1</a>.
</Aside>

Use this page as a reference for v1 global flags. v1 has no sub-commands.
...
For complete operational procedures, see [Service Management (v1)](/reference/archive/v1-deprecated/service/).
