...
description: Run the v1 collector as a Linux systemd service using built-in CLI flags.
sidebar:
  label: Service
  order: 4
---
...
<Aside type="caution">
This v1 page is deprecated. Use <a href={`${import.meta.env.BASE_URL}collector/standalone/service/`}>Standalone Service Management</a> for new deployments, or <a href={`${import.meta.env.BASE_URL}collector/standalone/migration/`}>Migrate from v1</a>.
</Aside>

Use this page to operate the v1 collector as a background Linux service.
