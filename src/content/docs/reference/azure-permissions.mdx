...
This page is a lookup reference for all Microsoft Graph permissions required by the collector. For the step-by-step setup guide, see [Azure Permissions](/collector/azure-permissions/).
