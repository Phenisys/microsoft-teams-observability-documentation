...
<Aside type="caution">
Keep `splunk_ssl_check: true` in production. Only disable TLS verification for testing with self-signed certificates, and re-enable it before going live.
</Aside>
...
If data is not arriving, see [Troubleshooting](/backends/splunk/troubleshooting/).
