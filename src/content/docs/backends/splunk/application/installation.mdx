...
You will use this token/URL in collector output configuration: [Collector Connection](/backends/splunk/configuration/).
...
This corresponds to optional `sites.csv` in collector configuration: [sites.csv option](/collector/v1/configuration/#optional-site-definition-csv).
