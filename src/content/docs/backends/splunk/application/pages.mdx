...
<Aside type="note">
For collector-side HEC setup details, use [Collector Connection](/backends/splunk/configuration/). For integration issues, use [Troubleshooting](/backends/splunk/troubleshooting/).
</Aside>
