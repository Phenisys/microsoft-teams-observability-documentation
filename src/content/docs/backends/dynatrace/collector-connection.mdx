...
✅ Success criteria:
- Collector logs show no Graph auth or export errors
- Dynatrace Logs view contains `MSTeams_CallRecords_*` records
- App Overview page displays real tenant data

❌ If this fails:
- <a href={`${import.meta.env.BASE_URL}backends/dynatrace/troubleshooting/`}>Dynatrace Troubleshooting</a>
- Re-run `test-connection` to confirm Graph and Dynatrace connectivity
