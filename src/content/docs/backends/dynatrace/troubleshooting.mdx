...
<Aside type="tip">
For collector-side connectivity issues (Microsoft Graph authentication, export errors), see <a href={`${import.meta.env.BASE_URL}collector/troubleshooting/`}>Collector Troubleshooting</a>.
</Aside>
