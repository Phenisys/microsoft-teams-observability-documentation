...
**Checks:**
1. Run `ms-teams-agent test-connection --config ./config.yaml` and confirm the Dynatrace output reports success.
...
4. Check collector logs for export errors (`tail -f logs/agent.log`).
