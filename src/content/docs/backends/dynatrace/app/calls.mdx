...
- Duration > 0: clickable link to <a href={`${import.meta.env.BASE_URL}backends/dynatrace/app/call-overview/`}>Call Overview</a>, with time padding around call interval.
...
| Action | Destination |
|--------|-------------|
| Click call ID (with recording) | <a href={`${import.meta.env.BASE_URL}backends/dynatrace/app/call-overview/`}>Call Overview</a> |
