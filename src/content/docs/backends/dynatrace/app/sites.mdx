...
<Aside type="caution">
If you haven't configured email domain filters yet, a warning toast will appear prompting you to go to [Configuration](../configuration/). Calls won't be filtered by domain until domains are set.
</Aside>
