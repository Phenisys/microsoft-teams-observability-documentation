...
**Purpose:** Upload and manage the CSV file that maps network subnets to site locations (used on the [Sites](../sites/) page).
...
- **Downloading call details** as JSON from the [Call Overview](../call-overview/) page
...
**Purpose:** Configure a list of **email domains** to restrict the data shown on the [Sites](../sites/) page. Only users whose email address ends with one of the configured domains are included in site-level analytics.
