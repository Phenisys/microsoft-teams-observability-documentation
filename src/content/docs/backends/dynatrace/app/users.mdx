...
| **Name** | User's display name. Clicking navigates to [Calls](../calls/) filtered for that user. Hover shows: *"See calls for this user"*. |
...
| Action | Destination |
|--------|-------------|
| Click a user name | [Calls](../calls/) page, pre-filtered for that user, with the same timeframe applied |
