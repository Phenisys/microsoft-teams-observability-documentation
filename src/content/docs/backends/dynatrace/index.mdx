...
<Aside type="tip">
If something is not working after setup, see <a href={`${import.meta.env.BASE_URL}backends/dynatrace/troubleshooting/`}>Troubleshooting</a> or the <a href={`${import.meta.env.BASE_URL}backends/dynatrace/faq/`}>FAQ</a>.
</Aside>
