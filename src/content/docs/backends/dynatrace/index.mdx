...
<Aside type="tip">
If something is not working after setup, see [Troubleshooting](/backends/dynatrace/troubleshooting/) or the [FAQ](/backends/dynatrace/faq/).
</Aside>
