...
If no data appears, check the [Collector Connection](/backends/dynatrace/collector-connection/) and [Troubleshooting](/backends/dynatrace/troubleshooting/) guides.
