...
<figure>
  ...
  <figcaption>Home dashboard with tenant-level call health and platform distribution.</figcaption>
</figure>

<figure>
  <img src={grafanaAppCallsPage.src} alt="Grafana MS Teams Observability calls list" />
  <figcaption>Calls page with filters, health status, and drilldown entry points.</figcaption>
</figure>
...
<CardGrid>
  <LinkCard
    ...
    description="A supported Grafana instance, a Loki datasource, and a collector sending MS Teams logs."
    href={`${import.meta.env.BASE_URL}getting-started/prerequisites/`}
  />
  <LinkCard
    title="2) Install the Plugin"
    description="Install the MS Teams Observability plugin from the Grafana Plugin Catalog."
  ...
  <LinkCard
    ...
    href={`${import.meta.env.BASE_URL}getting-started/deploy-grafana/`}
  />
  <LinkCard
