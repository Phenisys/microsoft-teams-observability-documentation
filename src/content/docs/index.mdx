...
<Steps>
1. Check [Prerequisites](/getting-started/prerequisites/) (Azure app, permissions, network access).
2. Deploy the [Collector](/collector/v1/installation/) and run one first cycle.
3. Connect your backend in [Backends](/backends/) (Dynatrace or Splunk).
