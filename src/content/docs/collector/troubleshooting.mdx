...
- Re-run from [v1 Installation](/collector/v1/installation/) with one output enabled first.
- Cross-check config with [v1 Configuration](/collector/v1/configuration/).
