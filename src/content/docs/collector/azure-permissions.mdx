...
For all available configuration fields, see <a href={`${import.meta.env.BASE_URL}collector/v1/configuration/`}>Configuration</a>.
...
2. In the [Microsoft Teams admin center](https://admin.microsoft.com/), go to **Voice** > **Voice applications policies**.
...
<Aside type="note">
Many advanced capabilities — including real-time metrics and most configuration options — require a **Teams Premium** license on this account. See the [Microsoft documentation](https://learn.microsoft.com/en-us/microsoftteams/manage-voice-applications-policies) for the full permissions matrix.
</Aside>
