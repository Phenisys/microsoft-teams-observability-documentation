...
<Aside type="note">
Azure app registration steps and full permissions reference are maintained in the canonical page: [Collector Azure Permissions](/collector/azure-permissions/).
</Aside>
