...
<Aside type="note">
For OTel outputs, `headers` must be provided and non-empty for each enabled entry. Common targets include Datadog, Dynatrace OTLP ingestion, and custom OpenTelemetry collectors. See [OTLP Backend Configuration](../../../backends/otlp/configuration/) for integration details.
</Aside>
