...
1. Configure Microsoft Graph access (see [Azure Permissions](/collector/v2/azure-permissions/)).
2. Download collector binary and template config.
3. Obtain your license file (see [License](/getting-started/license/)).
...
Full settings reference: [Configuration Reference](/collector/v2/configuration/)
...
See [Service Management](/collector/v2/service/) for Linux service operation.
...
<Aside type="tip">
If data still does not appear after one interval, follow [Runbook Troubleshooting](/collector/v2/runbook/#common-errors-and-fixes).
</Aside>
