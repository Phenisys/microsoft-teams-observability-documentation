---
title: Collector — Dynatrace Extension
...
<CardGrid>
  ...
  <LinkCard
    title="Upgrade"
    description="Routine patch/minor update procedure for the extension package."
    href={`${import.meta.env.BASE_URL}collector/extension/upgrade/`}
  />
  <LinkCard
