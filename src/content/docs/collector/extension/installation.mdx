...
- The extension package matching your ActiveGate OS:
  ...
  - Download from the [GitHub Releases](https://github.com/Phenisys/microsoft-teams-observability-dynatrace-extension/releases/latest) page
- Extension source repository: [microsoft-teams-observability-dynatrace-extension](https://github.com/Phenisys/microsoft-teams-observability-dynatrace-extension)
...
<Steps>
1. Download the correct extension ZIP from [GitHub Releases](https://github.com/Phenisys/microsoft-teams-observability-dynatrace-extension/releases/latest):
