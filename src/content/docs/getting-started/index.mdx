...
Demo and Live mode are specific to the Dynatrace application. Splunk and OTLP-compatible backends like Grafana Cloud and Datadog display data as soon as the collector exports records.
