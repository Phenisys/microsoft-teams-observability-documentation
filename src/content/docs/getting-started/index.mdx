...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Choose Dynatrace, Splunk, Grafana, or OTLP-compatible platforms like Datadog."
...
| **Grafana** | Yes — Grafana plugin app | Published on Plugin Catalog, Loki-based |
| **OTLP-compatible backend** | No native app | Use with Datadog, vendor OTLP gateways, or a custom receiver |
