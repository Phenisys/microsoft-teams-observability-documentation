...
- **Live mode** — uses real tenant data collected by the collector. Requires a valid license. See [License](/getting-started/license/).

Demo and Live mode are specific to the Dynatrace application. The Splunk and OTLP backends do not have a demo mode — they display data as soon as the collector starts sending it.
