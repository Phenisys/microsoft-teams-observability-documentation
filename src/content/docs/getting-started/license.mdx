...
| Estimated number of Microsoft Teams users per month | Used to size the license — see <a href={`${import.meta.env.BASE_URL}reference/license-estimation/`}>License Estimation</a> |
...
To determine how many licensed users you need, see <a href={`${import.meta.env.BASE_URL}reference/license-estimation/`}>License Estimation</a>.
