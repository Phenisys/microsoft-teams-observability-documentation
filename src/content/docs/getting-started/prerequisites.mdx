...
<Aside type="note">
For national cloud deployments (GCC High, DoD, China), the Microsoft Entra ID and Microsoft Graph endpoints differ from the global addresses listed above. Set `cloud_deployment` in your `microsoft_authentication` configuration — see [Configuration](../collector/v1/configuration/) for details.
</Aside>
