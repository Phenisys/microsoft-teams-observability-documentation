...
description: Step-by-step guide to deploy the collector and export Teams telemetry to any OTLP-compatible backend.
sidebar:
...
See <a href={`${import.meta.env.BASE_URL}backends/otlp/grafana/`}>OTLP to Grafana</a> for detailed setup.
